...
public class FeedRoadworks extends AsyncTask<Void, Void, Void> {
    Context cont;
    String urladdress = "http://trafficscotland.org/rss/feeds/plannedroadworks.aspx";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;

    public FeedRoadworks(Context cont, RecyclerView recyclerView) {
